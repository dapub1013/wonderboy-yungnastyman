...
Feat: Tavern Brawler
  ...
  - **Note:** Unequip main hand weapon once taking Tavern Brawler.
...
- Reference previous levels 1-6 of **Class: Monk** above, then proceed with the rest of this guide.
...
[x] Amulet: [Moondrop Pendant](https://bg3.wiki/wiki/Moondrop_Pendant)
  - `Owlbear Nest` Found in a Selûnite Gilded Chest; read the Selunite Prayer Sheet in front of the chest to unlock it `X: -321 Y: -135`
...
[x] Armour: [Vest of Soul Rejuvination](https://bg3.wiki/wiki/Vest_of_Soul_Rejuvenation)
...
[ ] Gloves: [Gloves of Soul Catching](https://bg3.wiki/wiki/Gloves_of_Soul_Catching)
...
[x] Ring: [Crusher's Ring](https://bg3.wiki/wiki/Crusher%27s_Ring)
  - `Goblin Camp` Worn by **Crusher**; slip it off his toe when he demands you kiss his foot, or loot from his corpse

[x] Ring: [Ring of Protection](https://bg3.wiki/wiki/Ring_of_Protection)
